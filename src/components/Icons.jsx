...
const icons = {
  ...
  aider: (
    <svg {...s}>
      ...
      <path d="M20 9L15 4l-9 9v5h5l9-9z" />
    </svg>
  ),
  windsurf: (
    <svg {...s}>
      <path d="M2 12a10 10 0 0 1 10-10c5.52 0 10 4.48 10 10s-4.48 10-10 10S2 17.52 2 12z" />
      <path d="M12 2v20M2 12h20M12 2a15.3 15.3 0 0 1 0 20" />
    </svg>
  ),
  deepseek: (
    <svg {...s}>
      ...
      <path d="M12 3a9 9 0 0 0 6 8.5M12 21a9 9 0 0 0-6-8.5" />
    </svg>
  ),
